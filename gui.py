...
class AnalyzerGUI(tk.Tk):
    ...
    def _build_ui(self):
        ...
        # --- Section 2: Profiles ---
        self.profile_frame = ttk.LabelFrame(main_frame, text=" 2. Active Profile Settings (Auto-Detected) ", padding="10")
        ...
        self.txt_log = tk.Text(console_frame, height=6, state=tk.DISABLED, background="#f4f4f4", wrap=tk.WORD)
    ...
    def _auto_load_system_profiles(self):
        ...
        self.log("Auto-detecting profile sets from configuration paths...")
        try:
            config.ensure_directories()
            manager = OrcaProfileManager()
            
            # Use dynamic discovery mapping to find names and insert application defaults cleanly
